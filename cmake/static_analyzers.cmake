    ...
    if(my_project_ENABLE_CPPCHECK)
        ...
        if(CPPCHECK)
            ...
            if("${CPPCHECK_OPTIONS}" STREQUAL "")
                # Enable all warnings that are actionable by the user of this toolset style should enable the other 3,
            ...
            message(STATUS "cppcheck options: ${CMAKE_CXX_CPPCHECK}")
        else()
...
macro(my_project_enable_clang_tidy target WARNINGS_AS_ERRORS)
    if(my_project_ENABLE_CLANGTIDY)
        ...
        if(CLANGTIDY)
            ...
            message(STATUS "clang-tidy options: ${CMAKE_CXX_CLANG_TIDY}")
        else()
